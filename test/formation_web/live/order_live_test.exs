defmodule FormationWeb.OrderLiveTest do
  use FormationWeb.ConnCase

  import Phoenix.LiveViewTest
  import Formation.DeliFixtures

  @create_attrs %{name: "some name", status: :draft, items: "some items", customer: "some customer", price: 120.5}
